...
export default function Navbar({ logFunction }) {
	...
	useEffect(() => {
		const handleResize = () => {
			setShow(
				window.innerWidth > 991 || (window.innerWidth < 991 && burgerOpened)
			);
		};
					...
					{!session && pathname == "/" ? (
						<>
							<div className="Navbar-item">
								<Link href="#UseCases" className="Navbar-button">
									Solution
								</Link>
							</div>
							<div className="Navbar-item">
								<Link href="#Technology" className="Navbar-button">
									Technology
								</Link>
							</div>
							<div className="Navbar-item">
								<Link href="#Integration" className="Navbar-button">
									Integration
								</Link>
							</div>
							<div className="Navbar-item">
								<Link href="#Channels" className="Navbar-button">
									Use-cases
								</Link>
							</div>
							<div className="Navbar-item">
								<Link href="#Testimonial" className="Navbar-button">
									Clients
								</Link>
							</div>
						</>
						...
						<>
							<div className="Navbar-item">
								<a className="Navbar-button" href="/applications/analytics">
									Dashboard Analytics
								</a>
							</div>
							<div className="Navbar-item">
								<a className="Navbar-button" href="/applications/prompt">
									Prompt app
								</a>
							</div>
						</>
